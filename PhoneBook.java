...
public class PhoneBook {
    ...
    private ArrayList<Contact> phone_book = new ArrayList<Contact>();
    public ArrayList<Contact> getPhoneBook(){return this.phone_book;}
    // Print menu function
    ...
    private static void delContact(ArrayList<Contact> phone_book,CalendarApp Calendar){
        ...
        for(Contact con : phone_book)
            ...
            {
                Calendar.RemoveAllContactEvents(con.getName());
    ...
    public static void loadFromFile(ArrayList<Contact> phone_book) {
        ...
        public static void main(String[] args) {
            ...
            addContact(pb.getPhoneBook());
            ca.AddEvent(pb);
            ca.AddEvent(pb);
            ca.AddEvent(pb);
            //  ca.printEventsByDay();
            ca.printAllEvents();
            delContact(pb.getPhoneBook(),ca);
            ca.printAllEvents();
...
//CHANGES IN DELCONTACT AND ADDED NEW FUNCTION CALLED searchContactByName
}
